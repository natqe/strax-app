            ...
            <div class="row userInfo">
                                    ...
                                    <table class="order-details-cart">
                                        ...
                                        <tr class="cartProduct">
                                            <td class="cartProductThumb" style="width:20%">
                                                <div><a href="{{ url('product-details') }}"> <img alt="img"
                                                                                          src="{{ asset('images/product/3.jpg') }}">
                                                </a></div>
                                            </td>
                                            <td style="width:40%">
                                                <div class="miniCartDescription">
                                                    <h4><a href="{{ url('product-details') }}"> TSHOP Tshirt DO9 </a></h4>
                                        ...
                                        <tr class="cartProduct">
                                            ...
                                            <td style="width:40%">
                                                <div class="miniCartDescription">
                                                    <h4><a href="{{ url('product-details') }}"> TShir TSHOP 09 </a></h4>
                                                    <span class="size"> 12 x 1.5 L </span>
                                        ...
                                        <tr class="cartProduct">
                                            ...
                                            <td style="width:40%">
                                                <div class="miniCartDescription">
                                                    <h4><a href="{{ url('product-details') }}"> Tshir 2014 </a></h4>
                                                    <span class="size"> 12 x 1.5 L </span>
                                        ...
                                        <tr class="cartProduct">
                                            ...
                                            <td style="width:40%">
                                                <div class="miniCartDescription">
                                                    <h4><a href="{{ url('product-details') }}"> TSHOP T shirt DO20 </a></h4>
                                                    <span class="size"> 12 x 1.5 L </span>
                                        ...
                                        <tr class="cartProduct">
                                            ...
                                            <td style="width:40%">
                                                <div class="miniCartDescription">
                                                    <h4><a href="{{ url('product-details') }}"> T shirt Black </a></h4>
                                                    <span class="size"> 12 x 1.5 L </span>
                                        ...
                                        <tr class="cartProduct">
                                            <td class="cartProductThumb" style="width:20%">
                                                <div><a href="{{ url('product-details') }}"> <img alt="img"
                                                                                          src="{{ asset('images/site/winter.jpg') }}">
                                                </a></div>
                                            </td>
                                            <td style="width:40%">
                                                <div class="miniCartDescription">
                                                    <h4><a href="{{ url('product-details') }}"> G Star T shirt </a></h4>
                                                    <span class="size"> 12 x 1.5 L </span>
                ...
                <div class="col-lg-12 clearfix">
                    <ul class="pager">
                        ...
                        <li class="next pull-left"><a href="{{ url('account') }}"> ← Back to My Account</a></li>
                    </ul>
                </div>
            </div>
            <!--/row end-->

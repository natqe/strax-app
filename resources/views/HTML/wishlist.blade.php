            ...
            <div class="row userInfo">
                    ...
                    <table>
                        ...
                        <tr class="CartProduct">
                            <td style="width:10%" class="CartProductThumb">
                                <div><a href="{{ url('product-details') }}"><img src="{{ asset('images/product/9.jpg') }}" alt="img"></a></div>
                            </td>
                            <td style="width:40%">
                                <div class="CartDescription">
                                    <h4><a href="{{ url('product-details') }}">Denim T shirt Black </a></h4>
                        ...
                        <tr class="CartProduct">
                            <td style="width:10%" class="CartProductThumb">
                                <div><a href="{{ url('product-details') }}">
                                    <img src="{{ asset('images/product/11.jpg') }}" alt="img"></a></div>
                            </td>
                            <td style="width:40%">
                                <div class="CartDescription">
                                    <h4><a href="{{ url('product-details') }}">Denim T shirt Black </a></h4>
                        ...
                        <tr class="CartProduct">
                            <td style="width:10%" class="CartProductThumb">
                                <div><a href="{{ url('product-details') }}">
                                    <img src="{{ asset('images/product/a2.jpg') }}" alt="img"></a></div>
                            </td>
                            <td style="width:40%">
                                <div class="CartDescription">
                                    <h4><a href="{{ url('product-details') }}">Denim T shirt Black </a></h4>
                        ...
                        <tr class="CartProduct">
                            <td style="width:10%" class="CartProductThumb">
                                <div><a href="{{ url('product-details') }}">
                                    <img src="{{ asset('images/product/a5.jpg') }}" alt="img"></a></div>
                            </td>
                            <td style="width:40%">
                                <div class="CartDescription">
                                    <h4><a href="{{ url('product-details') }}">Denim T shirt Black </a></h4>
                        ...
                        <tr class="CartProduct">
                            <td style="width:10%" class="CartProductThumb">
                                <div><a href="{{ url('product-details') }}">
                                    <img src="{{ asset('images/product/a4.jpg') }}" alt="img"></a></div>
                            </td>
                            <td style="width:40%">
                                <div class="CartDescription">
                                    <h4><a href="{{ url('product-details') }}">Denim T shirt Black </a></h4>
                        ...
                        <tr class="CartProduct">
                            <td style="width:10%" class="CartProductThumb">
                                <div><a href="{{ url('product-details') }}">
                                    <img src="{{ asset('images/product/a3.jpg') }}" alt="img"></a></div>
                            </td>
                            <td style="width:40%">
                                <div class="CartDescription">
                                    <h4><a href="{{ url('product-details') }}">Denim T shirt Black </a></h4>
                ...
                <div class="col-lg-12 clearfix">
                    <ul class="pager">
                        ...
                        <li class="next pull-left"><a href="{{ url('account') }}"> &larr; Back to My Account</a></li>
                    </ul>
                </div>
